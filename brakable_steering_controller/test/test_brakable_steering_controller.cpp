...
#include "test_brakable_steering_controller.hpp"
...
class brakableSteeringControllerTest
: public brakableSteeringControllerFixture<TestablebrakableSteeringController>
{
};

TEST_F(brakableSteeringControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
  ...
  ASSERT_EQ(controller_->brakable_params_.wheelbase, wheelbase_);
  ASSERT_EQ(controller_->brakable_params_.front_wheel_radius, front_wheels_radius_);
  ASSERT_EQ(controller_->brakable_params_.rear_wheel_radius, rear_wheels_radius_);
}

TEST_F(brakableSteeringControllerTest, check_exported_interfaces)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, update_success)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, test_update_logic)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, test_update_logic_chained)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(brakableSteeringControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(brakableSteeringControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
