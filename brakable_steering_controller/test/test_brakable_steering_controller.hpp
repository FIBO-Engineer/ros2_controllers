...
#ifndef TEST_brakable_STEERING_CONTROLLER_HPP_
#define TEST_brakable_STEERING_CONTROLLER_HPP_
...
using brakable_steering_controller::STATE_STEER_AXIS;
using brakable_steering_controller::STATE_TRACTION_WHEEL;

// name constants for command interfaces
using brakable_steering_controller::CMD_STEER_WHEEL;
using brakable_steering_controller::CMD_TRACTION_WHEEL;
...
class TestablebrakableSteeringController
: public brakable_steering_controller::brakableSteeringController
{
  FRIEND_TEST(brakableSteeringControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(brakableSteeringControllerTest, check_exported_interfaces);
  FRIEND_TEST(brakableSteeringControllerTest, activate_success);
  FRIEND_TEST(brakableSteeringControllerTest, update_success);
  FRIEND_TEST(brakableSteeringControllerTest, deactivate_success);
  FRIEND_TEST(brakableSteeringControllerTest, reactivate_success);
  FRIEND_TEST(brakableSteeringControllerTest, test_update_logic);
  FRIEND_TEST(brakableSteeringControllerTest, test_update_logic_chained);
  FRIEND_TEST(brakableSteeringControllerTest, publish_status_success);
  FRIEND_TEST(brakableSteeringControllerTest, receive_message_and_publish_updated_status);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    return brakable_steering_controller::brakableSteeringController::on_configure(previous_state);
  }
    ...
    const rclcpp_lifecycle::State & previous_state) override
  {
    ...
    return brakable_steering_controller::brakableSteeringController::on_activate(previous_state);
  }
...
class brakableSteeringControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_brakable_steering_controller/reference", rclcpp::SystemDefaultsQoS());
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_brakable_steering_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_brakable_steering_controller/controller_state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestablebrakableSteeringController> controller_;
  rclcpp::Node::SharedPtr command_publisher_node_;
  rclcpp::Publisher<ControllerReferenceMsg>::SharedPtr command_publisher_;
};

#endif  // TEST_brakable_STEERING_CONTROLLER_HPP_
