...
#include "test_brakable_velocity_controller.hpp"
...
using brakable_velocity_controller::feedforward_mode_type;

class BrakableVelocityControllerTest : public BrakableVelocityControllerFixture<TestableBrakableVelocityController>
{
};

TEST_F(BrakableVelocityControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, check_exported_interfaces)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, update_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, test_feedforward_mode_service)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, test_update_logic_feedforward_off)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(BrakableVelocityControllerTest, test_update_logic_feedforward_on)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(BrakableVelocityControllerTest, test_update_logic_chainable_feedforward_off)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(BrakableVelocityControllerTest, test_update_logic_chainable_feedforward_on)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
 ...
 */
TEST_F(BrakableVelocityControllerTest, test_update_logic_angle_wraparound_off)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
 ...
 * @brief check default calculation with angle_wraparound turned off
 */
TEST_F(BrakableVelocityControllerTest, test_update_logic_angle_wraparound_on)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(BrakableVelocityControllerTest, subscribe_and_get_messages_success)
{
  SetUpController();
...
TEST_F(BrakableVelocityControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
