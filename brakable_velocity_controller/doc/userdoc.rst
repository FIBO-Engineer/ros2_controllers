:github_url: https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/brakable_velocity_controller/doc/userdoc.rst
...
Plugin name: brakable_velocity_controller/BrakableVelocityController
...
List of parameters
=========================
.. generate_parameter_library_details:: ../src/brakable_velocity_controller.yaml
...
An example parameter file for this controller can be found in `the test folder (standalone) <https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/brakable_velocity_controller/test/brakable_velocity_controller_params.yaml>`_:

.. literalinclude:: ../test/brakable_velocity_controller_params.yaml
   :language: yaml

or as `preceding controller <https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/brakable_velocity_controller/test/brakable_velocity_controller_preceding_params.yaml>`_:

.. literalinclude:: ../test/brakable_velocity_controller_preceding_params.yaml
   :language: yaml
